...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nickname' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'FK_post_topic_id' => ['type' => 'index', 'columns' => ['topic_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['post_id'], 'length' => []],
            'FK_post_topic_id' => ['type' => 'foreign', 'columns' => ['topic_id'], 'references' => ['topics', 'topic_id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'topic_id' => 1,
            'created' => '2018-02-16 14:04:48',
            'modified' => '2018-02-16 14:04:48',
            'ip' => 'Lorem ipsum d'
        ],
    ];
}
